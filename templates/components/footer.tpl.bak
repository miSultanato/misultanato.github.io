<footer class="flex items-center justify-center mt-2 mb-8 space-x-4 text-center text-gray-800">
    ...
    <div>
        <a href="${ema:homeUrl}" title="Página de Inicio">
    ...
    <div>
        <a href="${ema:indexUrl}" title="Ver Index">
    ...
    <div>
        <a href="${ema:tagIndexUrl}" title="Ver tags">
            <svg class="${iconClass}" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div>
        <a href="${ema:taskIndexUrl}" title="Ver tareas">
            <svg xmlns="http://www.w3.org/2000/svg" class="${iconClass}" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
